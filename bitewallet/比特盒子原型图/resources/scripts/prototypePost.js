...
(function () {
    ...
    //Used by sitemap and variables.lang getLinkUrl functions so that they know
...
//        var y = JSON.stringify(axEventObject);
    ...
    var _initializeObjectEvents = function(query, allowItem) {
        query.each(function(dObj, elementId) {
            ...
            // Unless you are pre eval - don't allow item and have an item id - then set enabled/selected through lang as usual
            if(allowItem || !itemId) {
    ...
    //if forceSwitchTo is true, we will also update the checkmark in sitemap.lang
...
$axure.internal(function($ax) {
    ...
    // TODO: [ben] Consider moving this to repeater.lang
