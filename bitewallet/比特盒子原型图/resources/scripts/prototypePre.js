...
(function() {
    ...
    $axure.internal = function(initFunction) {
        //Attach messagecenter to $ax object so that it can be used in viewer.lang, etc in internal scope
...
//            var wasShown = $ax.visibility.IsIdVisible(elementId);
    ...
    var _fixedOffset = function (id, vert) {
        ...
        // TODO:  Look into replacing this with axquery width/height and fixing that to use this hack. Potentially want to make lang generic trapper.
